...
Tabellen:
- customers (id uuid PK, customer_number varchar, company_name varchar, first_name varchar, last_name varchar, email varchar, phone varchar, street varchar, zip varchar, city varchar, country varchar, is_active bool, notes text, created_at timestamptz)
...
- creditors (id uuid PK, creditor_number varchar, company_name varchar, first_name varchar, last_name varchar, email varchar, iban varchar, bic varchar, street varchar, zip varchar, city varchar, country varchar, is_active bool, notes text, created_at timestamptz)
...
- Kunden ohne aktiven Vertrag: LEFT JOIN contracts ... WHERE contracts.id IS NULL
